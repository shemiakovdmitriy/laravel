...
<form method="post" action="{{route('post')}}" enctype="multipart/form-data">
       <p>Название курса: <input type="text" name="name">
       </p>
       <p>Описание: <textarea name="description"></textarea>
       </p>
       <p>Время начала: <input type="datetime-local" name="time" value="2020-07-01T10:00">
       </p>
       <p>Кол-во мест: <input type="quantity" min="0" name="quantity" value="0">
       </p>
